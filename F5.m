% Show locations of earthquakes and EW-test results for FORGE.
...
load('FORGE-c1.mat','D');  D1=D;   % Cluster 1.
load('FORGE-c2a.mat','D'); D2a=D;  % Cluster 2a.
load('FORGE-c2.mat','D');  D2=D;   % Cluster 2.
load('FORGE-c3.mat','D');  D3=D;   % Cluster 3.
%load('FORGE-c4.mat','D');  D4=D;
%load('FORGE-s6.mat','D');  D6=D;
D(1)=D3; D(2)=D1; D(3)=D2; D(4)=D2a;  %D(5)=D3a; D(6)=D3; 
