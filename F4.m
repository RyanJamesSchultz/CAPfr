% Show locations of earthquakes and EW-test results for Helsinki St1.
...
%S( 4).Stage=4;  S( 4).Ploc(1,:)=[3180 3182];  % S4.
%S( 5).Stage=5;  S( 5).Ploc(1,:)=[3162 3164];  % S5.


% Get all of the case data.
load('St1-all.mat','D'); %D1=D;   % Cluster 1.
