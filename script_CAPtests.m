...
% Used to inform Text S3-S5 and make Figures S10, S13, S18-S21, S25-S28, etc.
clear;
...
for k=1:length(D)
    ...
    % Apply various ad hoc filters or perturbations.
    %[~,I]=maxk(M,5);
    %M(I)=M(I)+0.3;
    %i=find((M<1.26752)&(M>1.26750));
    %M(i)=NaN;
    %I=Lon>800;
    %Lat=Lat(I); Lon=Lon(I); Dep=Dep(I); T=T(I); M=M(I);
    %m1b=m1b+0.2;
...
% Define some plotting details that I'll need.
